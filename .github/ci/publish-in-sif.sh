...
# (project=scitex-db, owner=ywatanabe1989, repo=scitex-db,
...
TMPDIR="/tmp/publish-scitex_db-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-db dist/* uploaded to PyPI via manual OIDC trusted publishing"
